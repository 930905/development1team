...
public class FreeReplyMapperTests {
	...
	private Long[] bnoArr = {589901L, 721001L, 720980L, 720973L, 720972L};
	...
	public void testRead() {
		Long targetRno = 2000L;
		
		FreeReplyVO vo = freemapper.read(targetRno);
	...
	public void testUpdate() {
		...
		vo.setReply("민갸 또 성공한거니? ?! 와우~ ^^");
		
		int count = freemapper.update(vo);
	...
	public void testList() {
		...
		List<FreeReplyVO> replies = freemapper.getListWithPaging(cri, bnoArr[3]);
	...
	public void testList2() {
		...
		List<FreeReplyVO> replies = freemapper.getListWithPaging(cri, 1530L);
		replies.forEach(reply -> log.info(reply));
	}
