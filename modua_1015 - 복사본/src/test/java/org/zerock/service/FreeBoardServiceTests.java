...
public class FreeBoardServiceTests {
	...
	public void testRegister() {
		...
		freeboard.setTitle("FreeBoardServiceTests에서 생성한 새로운 글 제목");
		freeboard.setContent("새로운 글 내용");
		freeboard.setWriter("퐁키");
		
		freeservice.register(freeboard);
		log.info("BoardServiceTests에서 생성된 게시물의 번호 : " + freeboard.getBno());
	}
...
//		service.getList().forEach(board -> log.info(board));
	...
	public void testRemove() {
		...
		log.info("REMOVE RESULT : " + freeservice.remove(44L)); // 44번 게시글 삭제 처리
	}
