...
//		board.setFree_title("BoardServiceTests에서 생성한 새로운 글 제목");
//		board.setFree_content("새로운 글 내용");
//		board.setFree_writer("퐁키");
//		
//		service.register(board);
//		log.info("BoardServiceTests에서 생성된 게시물의 번호 : " + board.getFree_bno());
//	}
...
//		board.setFree_title("1번 글의 제목을 수정합니다!");
